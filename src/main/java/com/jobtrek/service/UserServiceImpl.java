...
public class UserServiceImpl implements UserService {
    ...
    public ResponseDTO changePassword(LoginDTO loginDTO) throws JobPortalException {
        ...
        notification.setMessage("Password Reset Successful");
    ...
    /**
     * Scheduled task that runs every minute to clean up expired OTPs.
     * Removes OTP records older than 5 minutes.
     */
